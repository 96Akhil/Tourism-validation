...
function login(){
    if((loginValidateemail()==true)&&(loginValidatepwd()==true)){
        alert("Login successful");
        location.reload();
    }
    else{

        if(loginValidateemail()==false){
            loginemail.style.border="2px solid red"
        }
        else if(loginValidatepwd()==false){
            loginpwd.style.border = "2px solid red"
        }
